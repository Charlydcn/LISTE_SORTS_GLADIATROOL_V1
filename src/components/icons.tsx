...
const TONIC_STAT_ICONS: Array<{ pattern: RegExp; file: string; label: string }> = [
  ...
  { pattern: /Coups critiques?/i, file: "Ini.svg", label: "Coups critiques" },
  { pattern: /Soins?/i, file: "Vita.svg", label: "Soins" },
  { pattern: /Dommages?/i, file: "NeutralDamage.svg", label: "Dommages" },
